...
<head>
  ...
  <title>Browse All Recipes | HungryTime</title>
...
<body>
    ...
    <div class="nav-wrapper">
      <div class="nav-divider">
        ...
        <div class="nav-main-wrapper">
          ...
          <a href="recipes.php" class="nav-active">
            <div class="nav-icon-wrapper">
      ...
      <div class="nav-divider">
        <div class="not-sure-wrapper">
          ...
          <a href="category-recipes.php?country=<?php echo $not_sure_country;?>&origin=recipes.php">
            <h4>Explore</h4>
  ...
  <div class="main-body">
    <div class="main-body-wrapper recipes-body-wrapper">
      <section class="main-body-header">
        <h2>What are you cooking today?</h2>
  
        <div class="search-bar-wrapper">
          <form class="search-bar" method="POST" action="category-recipes.php?origin=recipes.php<?php
          ...
          <?php
            if($username!="Guest") { ?>
              <a href="favorites.php?origin=recipes.php" class="faves-icon-wrapper">
      ...
      <section class="home-recommended recipes-country-section">
        <div class="recipe-country-name">
          ...
          <a href="category-recipes.php?country=<?php echo $country;?>&origin=recipes.php">
            <p>View All</p>
        ...
        <input type="radio" name="<?php echo $country;?>-recommended-options" id="<?php echo $country;?>-recommended-radio-1" hidden checked>
        <input type="radio" name="<?php echo $country;?>-recommended-options" id="<?php echo $country;?>-recommended-radio-2" hidden>
        <input type="radio" name="<?php echo $country;?>-recommended-options" id="<?php echo $country;?>-recommended-radio-3" hidden>
        <input type="radio" name="<?php echo $country;?>-recommended-options" id="<?php echo $country;?>-recommended-radio-4" hidden>

        <div class="home-recommended-wrapper-all">
          <label for="<?php echo $country;?>-recommended-radio-2" class="carousel-label carousel-label-right carousel-label-1">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="<?php echo $country;?>-recommended-radio-1" class="carousel-label carousel-label-left carousel-label-2">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="<?php echo $country;?>-recommended-radio-3" class="carousel-label carousel-label-right carousel-label-2">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="<?php echo $country;?>-recommended-radio-2" class="carousel-label carousel-label-left carousel-label-3">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="<?php echo $country;?>-recommended-radio-4" class="carousel-label carousel-label-right carousel-label-3">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="<?php echo $country;?>-recommended-radio-3" class="carousel-label carousel-label-left carousel-label-4">  
            <img src="Images/Icons/arrow-right-small.svg">
          </label>

          <?php for($j = 1; $j < 5; $j++) {?>

          <div class="home-recommended-wrapper" id="<?php echo $country;?>-recommended-<?php echo $j;?>">
            ...
            ?>
              <a href="recipe-main.php?recipe_id=<?php echo $recipe_id;?>&origin=recipes.php" class="home-recommended-recipe">
      ...
      <!-- <section class="home-recommended">
        <h3>Italian</h3>
        <input type="radio" name="italy-recommended-options" id="italy-recommended-radio-1" hidden checked>
        <input type="radio" name="italy-recommended-options" id="italy-recommended-radio-2" hidden>
        <input type="radio" name="italy-recommended-options" id="italy-recommended-radio-3" hidden>
        <div class="home-recommended-wrapper-all">
          <label for="italy-recommended-radio-2" class="carousel-label carousel-label-right carousel-label-1">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="italy-recommended-radio-1" class="carousel-label carousel-label-left carousel-label-2">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="italy-recommended-radio-3" class="carousel-label carousel-label-right carousel-label-2">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <label for="italy-recommended-radio-2" class="carousel-label carousel-label-left carousel-label-3">
            <img src="Images/Icons/arrow-right-small.svg">
          </label>
          <div class="home-recommended-wrapper" id="italy-recommended-1">
          ...
          <div class="home-recommended-wrapper" id="italy-recommended-2">
            <a href="" class="home-recommended-recipe">
              <div class="home-recommended-recipe-img-wrapper">
                <img src="Images/Food/KoreanRolledEggOmelette_SouthKorea_Lunch.jpg">
              </div>
          ...
          <div class="home-recommended-wrapper" id="italy-recommended-3">
            <a href="" class="home-recommended-recipe">
              <div class="home-recommended-recipe-img-wrapper">
                <img src="Images/Food/KoreanRolledEggOmelette_SouthKorea_Lunch.jpg">
              </div>
        ...
        <div class="sidebar-user">
          ...
          <?php if($username=="Guest") { ?>
            ...
            <div class="sidebar-user-name">
              <p><a href="login.php?origin=recipes.php">Login</a>/<a href="login.php?signup=yes&origin=recipes.php">Signup</a></p>
            </div>
          ...
          <?php } else { ?>
            ...
            <div class="sidebar-user-name sidebar-user-name-active">
              ...
              <a href="login.php?origin=recipes.php">Change Account</a>
            </div>
        ...
        <?php
          if($username!="Guest") { ?>
            <div class="sidebar-recently-viewed-wrapper">
              ...
              <a href="recipe-main.php?recipe_id=<?php echo $recently_viewed_recipe['recipe_id'];?>&origin=recipes.php" class="sidebar-recently-viewed-recipe">
