...
<head>
  ...
  <title>Categories | HungryTime</title>
...
<body>
    ...
    <div class="nav-wrapper">
      <div class="nav-divider">
        ...
        <div class="nav-main-wrapper">
          ...
          <a href="categories.php" class="nav-active">
            <div class="nav-icon-wrapper">
      ...
      <div class="nav-divider">
        <div class="not-sure-wrapper">
          ...
          <a href="category-recipes.php?country=<?php echo $not_sure_country;?>&origin=categories.php">
            <h4>Explore</h4>
  ...
  <div class="main-body">
    <div class="main-body-wrapper categories-main-body-wrapper">
      <section class="main-body-header">
        <h2>What are you cooking today?</h2>
  
        <div class="search-bar-wrapper">
          <form class="search-bar" method="POST" action="category-recipes.php?origin=categories.php<?php
          ...
          <?php
            if($username!="Guest") { ?>
              <a href="favorites.php?origin=categories.php" class="faves-icon-wrapper">
      ...
      <section  class="categories-main-wrapper">
        <h3>Categories</h3>

        <div class="categories-country-wrapper">
          <a href="category-recipes.php?country=French&origin=categories.php" class="categories-country">
            <img src="Images/Others/France.svg">
            <span>&nbsp;</span>
          </a>

          <a href="category-recipes.php?country=Italian&origin=categories.php" class="categories-country">
            <img src="Images/Others/Italy.svg">
            <span>&nbsp;</span>
          </a>

          <a href="category-recipes.php?country=Japanese&origin=categories.php" class="categories-country">
            <img src="Images/Others/Japan.svg">
            <span>&nbsp;</span>
          </a>

          <a href="category-recipes.php?country=Korean&origin=categories.php" class="categories-country">
            <img src="Images/Others/Korea.svg">
            <span>&nbsp;</span>
          </a>

          <a href="category-recipes.php?country=Spanish&origin=categories.php" class="categories-country">
            <img src="Images/Others/Spain.svg">
            <span>&nbsp;</span>
          </a>
        </div>
        ...
        <div class="sidebar-user">
          ...
          <?php if($username=="Guest") { ?>
            ...
            <div class="sidebar-user-name">
              <p><a href="login.php?origin=categories.php">Login</a>/<a href="login.php?signup=yes&origin=categories.php">Signup</a></p>
            </div>
          ...
          <?php } else { ?>
            ...
            <div class="sidebar-user-name sidebar-user-name-active">
              ...
              <a href="login.php?origin=categories.php">Change Account</a>
            </div>
        ...
        <?php
          if($username!="Guest") { ?>
            <div class="sidebar-recently-viewed-wrapper">
              ...
              <a href="recipe-main.php?recipe_id=<?php echo $recently_viewed_recipe['recipe_id'];?>&origin=categories.php" class="sidebar-recently-viewed-recipe">
